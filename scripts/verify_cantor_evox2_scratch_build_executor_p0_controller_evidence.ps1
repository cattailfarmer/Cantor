...
$expected = @{ artifact_count = 24; focused_tests = 8; stage_count = 10; effectful_stage_count = 7; isolated_successes = 1; isolated_refusals = 4; provider_requests = 0; remote_calls = 0; effects = 0 }
...
"cantor_evox2_scratch_build_controller_evidence_verified=true artifacts=24 focused_tests=8 stages=10 effectful_stages=7 isolated_successes=1 isolated_refusals=4 provider_requests=0 remote_calls=0 remote_contact_authorized=false effects=0"
