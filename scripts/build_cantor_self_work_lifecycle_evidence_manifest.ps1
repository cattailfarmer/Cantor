[CmdletBinding()]
param(
    [string]$OutputPath = 'experiments/self_work_lifecycle_admission_p0/artifacts/self_work_lifecycle_evidence_manifest.json'
)
...
$paths = @(
    ...
    'feature_support/Cantor_Self_Work_Lifecycle_Source_To_Substrate_Audit.sop',
    'feature_support/Cantor_Self_Work_Lifecycle_Admission_P0_Requirement_Matrix.sop',
    'narrative/Project_Narrative.sop',
    'narrative/file_changes/1787511700000_self_work_lifecycle_admission_p0_file_change.sop',
    'narrative/operational_faults/1787511700000_self_work_lifecycle_admission_p0_faults.sop',
    'narrative/reentry/Cantor_Self_Work_Lifecycle_Admission_P0_Reentry.sop',
    'narrative/registries/Cantor_Self_Work_Lifecycle_Admission_P0_Phase_Lock.sop',
    'narrative/research/Cantor_Self_Work_Lifecycle_Admission_P0_Completion_Review_2026-08-23.sop',
    'narrative/research/Cantor_Self_Work_Lifecycle_Admission_P0_SJS_Review_2026-08-23.sop',
    'narrative/turns/1787509300000_self_work_lifecycle_admission_p0_activation.sop',
    'narrative/turns/1787511700000_self_work_lifecycle_admission_p0_completion.sop',
    'plans/Cantor_Nested_LLM_Host_Contract_Sequence_Plan.sop',
    'plans/Cantor_Self_Work_Lifecycle_Admission_P0_Plan.sop',
    'proofs/Cantor_Objective_Work_Plan_Admission_P0_Proof.sop',
    'proofs/Cantor_Self_Work_Lifecycle_Admission_P0_Proof.sop',
    'scripts/build_cantor_self_work_lifecycle_evidence_manifest.ps1',
    'scripts/test_cantor_self_work_lifecycle_evidence.ps1',
    'scripts/verify_cantor_self_work_lifecycle_evidence.ps1',
    'solutions/Cantor_Self_Work_Lifecycle_Admission_P0_Solution.sop',
    ...
    'specifications/exploded/Cantor_Self_Work_Lifecycle_Admission_P0.exploded.sop'
)
...
$manifest = [ordered]@{
    profile = 'cantor-self-work-lifecycle-evidence-manifest/0.1'
    evidence_manifest_uuid = '9e82af95-f891-4200-9ac9-13c750c555f2'
    canonical_uuid = '0ba80ace-d2ae-4846-b3fd-f954f28f84a5'
    source_uuid = '521e430b-1371-44ad-8364-f1420fd43c25'
    source_commit = $sourceCommit
    generated_at_utc = [DateTime]::UtcNow.ToString('o')
    artifacts = @($artifacts)
    non_authority_statement = 'This manifest binds pure self-work lifecycle representation and validation. It proves no workspace admission, capability grant, physical work, test execution, update, review, commit, push, provider call, persistence, external effect, SOP authorship, signature, activation, remote access, FPGA, or Minecraft authority.'
}
