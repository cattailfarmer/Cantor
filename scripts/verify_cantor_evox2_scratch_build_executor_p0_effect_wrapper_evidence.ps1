...
if (@($manifest.artifacts).Count -ne 32) { throw 'effect-wrapper evidence artifact count differs' }
$seen = @{}
...
$expected = @{ artifact_count = 32; focused_tests = 15; stage_count = 10; effectful_stage_count = 7; checked_fixture_forms = 5; isolated_successes = 1; isolated_refusals = 5; provider_requests = 0; remote_calls = 0; effects = 0 }
