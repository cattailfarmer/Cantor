...
if (@($manifest.artifacts).Count -ne 42) { throw 'effect-wrapper evidence artifact count differs' }
$seen = @{}
...
$expected = @{ artifact_count = 42; focused_tests = 18; stage_count = 10; effectful_stage_count = 7; checked_fixture_forms = 5; observation_compiler_cases = 10; isolated_successes = 1; isolated_refusals = 5; provider_requests = 0; remote_calls = 0; effects = 0 }
