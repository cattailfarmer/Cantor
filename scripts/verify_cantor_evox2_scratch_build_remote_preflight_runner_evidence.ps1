...
if (@($manifest.artifacts).Count -ne 31) { throw 'runner evidence artifact count differs' }
$seen = @{}
...
"cantor_evox2_scratch_build_remote_preflight_runner_evidence_verified=true artifacts=31 focused_tests=10 public_permit_constructors=0 invocation_binaries=0 provider_requests_performed=0 remote_calls_performed=0 effects_performed=0 live_invocations_performed=0 exact_gates=$([bool] $manifest.verification.exact_workspace_gates_passed)"
