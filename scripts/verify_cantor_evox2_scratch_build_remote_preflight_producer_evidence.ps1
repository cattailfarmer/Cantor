...
if (@($manifest.artifacts).Count -ne 30) { throw 'producer evidence artifact count differs' }
$seen = @{}
...
$expected = @{ artifact_count = 30; focused_tests = 9; argument_atoms = 19; timeout_ms = 30000; stdout_limit_bytes = 65536; stderr_limit_bytes = 65536; provider_requests_performed = 0; remote_calls_performed = 0; effects_performed = 0 }
...
"cantor_evox2_scratch_build_remote_preflight_producer_evidence_verified=true artifacts=30 focused_tests=9 argument_atoms=19 provider_requests_performed=0 remote_calls_performed=0 effects_performed=0 remote_contact_authorized=false exact_gates=$([bool] $manifest.verification.exact_workspace_gates_passed)"
