...
$paths = @(
    ...
    'proofs/Cantor_EVO_X2_Scratch_Build_Executor_P0_Corrected_Package_Construction_Proof.sop',
    'feature_support/reviews/CantorEVOX2ScratchBuildExecutorP0CorrectedPackageConstructionReview.sop',
    'narrative/registries/Cantor_EVO_X2_Scratch_Build_Executor_P0_Corrected_Package_Construction_Phase_Checkpoint.sop',
