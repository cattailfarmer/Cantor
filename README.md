...
Current self-work frontier (2026-08-28): the bounded SWA-05 B1 production-preparation planner is published at `2ae87673` with bookend `1b70fbd4`; its exact provider-free commission proposal is published at `1844d5d8` with bookend `98683316`. The separately sourced and signed detached operator-decision verifier is published remote-equal at `9aaaab26` with bookend `bfc068ff` under canonical `0462098c-289e-440b-b515-c0090f9ecee1` and signature `69a95cf0-15d1-418b-9796-1fa5ae506499`. Safe Rust strictly replays the exact proposal, verifies supplied Ed25519 authorize or reject correspondence, emits explicit nonauthority receipts, and independently replays exact seven-file fixture evidence. Focused debug and overflow-checked release each pass twelve active tests with zero failures and one governed ignored producer; exact workspace debug and release each pass 230 groups with 1,436 tests, zero failures, and eleven governed ignores. Bounded authorize, reject, and evidence CLIs, warnings-denied workspace and experiment Clippy, format, and the 73-manifest/2,282-reference graph pass. The next source now closes a no-effect operator-authority ceremony plan that enumerates real policy, key-custody, revocation, time, live-decision, observation, permit, broker-projection, and physical-preparation prerequisites without fabricating any of them. This surface grants no key generation, policy governance, decision issuance, current time or freshness, private permit, broker projection, physical preparation, or effect.
